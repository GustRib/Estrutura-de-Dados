...
int main()
{
    ...
    cout << "A lista 1 tem " << L1.numNos() << " nos" << endl;
    cout << "A lista 2 tem " << l2.numNos() << " nos" << endl;

        int indice = L1.buscaMaior(45);
    if (indice != -1)
    ...
    //L1.calculaMedia();
    cout << "A media dos nos e: "<<  L1.calculaMedia() << endl;

    L1.concatena(&l2);
    cout << "a lista concatenada e: " << endl;
    L1.imprime();
    cout << "A lista concatenada tem " << L1.numNos() << " nos" << endl;
